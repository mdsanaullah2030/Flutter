        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Garry Allen', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            ...
            ClipRRect(
              borderRadius: BorderRadius.circular(16),
              child: Image.network(
                'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjM1fHxiZWF1dGlmdWwlMjBob3VzZXxlbnwwfHwwfHx8MA%3D%3D',
                height: 150,
                width: double.infinity,
                fit: BoxFit.cover,
              ),
